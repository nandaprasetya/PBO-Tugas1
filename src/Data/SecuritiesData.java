...
public class SecuritiesData {
    private static ArrayList<Stocks> stocksList = new ArrayList<>();
    private static ArrayList<SBNs> sbnsList = new ArrayList<>();
    ...
    static {
        ...
        sbnsList.add(new SBNs("FR0087", "Obligasi Negara 2025", 1000000, 10000, 6.0, 12, LocalDate.of(2025, 1, 1)));
